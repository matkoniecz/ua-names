...
def main():
    for file in ['miasta_unified.csv']: #['miasta_unified.csv']:
            ...
            for row in spamreader:
                if row_index == 0:
                    ...
                    if row[1] != "name":
                        ...
                        raise
                    if row[2] != "name:ru":
                        print(file, "name:ru expected", row[2], "arrived")
                        raise
                    if row[3] != "name:uk":
        ...
        with open(file, newline='') as csvfile:
            ...
            for row in spamreader:
                if row_index == 0:
                    ...
                    if ("name:ru" not in tags or element["tag"]["name:ru"] != name_ru) and name_ru.strip() != "":
